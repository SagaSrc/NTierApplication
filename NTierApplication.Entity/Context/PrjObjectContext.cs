...
using NTierApplication.Entity.Mapping;



namespace NTierApplication.Entity.Context
{
    /// <summary>
    /// Object context
    /// </summary>
    public class PrjObjectContext : DbContext, IDbContext
    {
        #region Ctor
        ...
        public PrjObjectContext(string nameOrConnectionString="Myconn")
            : base(nameOrConnectionString)
        {
            Database.SetInitializer(new DropCreateDatabaseIfModelChanges<PrjObjectContext>());
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            .Where(type => type.BaseType != null && type.BaseType.IsGenericType &&
                type.BaseType.GetGenericTypeDefinition() == typeof(AllEntityTypeConfiguration<>));
